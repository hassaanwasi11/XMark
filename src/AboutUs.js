...
function AboutUs() {
  ...
  return (
    <>
      ...
      <div class="relative">
        ...
        <div class="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <h1 class="text-white text-3xl sm:text-6xl font-bold">
            ...
            <span className="text-[#4cbfc7]">Your </span>
            <span className="text-white">Online </span>
            <br />
            <span className="text-[#4cbfc7]">Business </span>
            <span className="text-white">with </span>
            <span className="text-[#4cbfc7]">Our Company </span>
          </h1>
        </div>
      </div>
      ...
      <div className="container-fluid flex sm:flex-row flex-wrap-reverse flex-col mt-5 p-2 ">
        <div className="w-full md:w-1/2 px-4">
          <p className="text-xl font-bold sm:text-4xl mb-4 sm:text-start text-center">
            <span className="text-[#006261] text-left">Our </span>{" "}
