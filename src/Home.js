...
const Home = () => {
  ...
  const headingAnimation = useSpring({ opacity: 1, from: { opacity: 0 }, config: { duration: 1000 } });

  // Define the spring animation for the first image
  const firstImageAnimation = useSpring({ opacity: 1, from: { opacity: 0 }, config: { duration: 1000 } });
    ...
    <hr/>
      ...
      <div className="item-container p-2">
        ...
        <div className="number-container">
         <h1 className="text-[#11468F] font-bold text-5xl mt-2"><AnimatedNumber finalNumber={200} />+</h1>
          <p>Happy Customers</p>
        </div>
      </div>
      ...
      <div className="item-container p-2">
        ...
        <div className="number-container">
        <h1 className="text-[#11468F] font-bold text-5xl mt-2"><AnimatedNumber finalNumber={7} / >+</h1>
